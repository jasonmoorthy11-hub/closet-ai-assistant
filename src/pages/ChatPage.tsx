...
const PHOTO_LOADING_MESSAGES = [
  "Squinting at your closet like an art critic",
  "Mentally evicting the wire hangers",
  "Giving your shoes a better life",
  "Arguing with the AI about shelf height",
  "Virtually Marie Kondo-ing your space",
  "Choosing a finish that sparks joy",
  "Teaching your closet to reach its full potential",
  "Replacing chaos with cabinetry",
  "Making your hangers weep with pride",
  "Convincing the AI that more shoe storage is always the answer",
  "Drafting blueprints at an alarming speed",
  "Folding the fitted sheet... digitally",
  "Performing closet surgery",
  "Rendering something your friends will be jealous of",
  "Wondering if we should add a chandelier",
];

// Messages shown for text-only responses (chat path — takes 2-5s)
const TEXT_LOADING_MESSAGES = [
  "Consulting the closet oracle",
  "Flipping through the design playbook",
  "Debating white vs. ivory (it matters)",
  "Channeling my inner interior designer",
  "Pulling swatches from the mental catalog",
  "Calculating the optimal hanger gap",
  "Overthinking your shelf arrangement",
  "Having a moment with the finish samples",
  "Running the numbers on drawer space",
  "Brainstorming something beautiful",
];
